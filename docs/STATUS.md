...
audio, storage, lifecycle, multiplayer, or Mac runtime
change. The Mac executable and package remain byte-identical to Preview 6.
Hands-on review reconfirmed pre-existing horizontal-mouse sluggishness without
