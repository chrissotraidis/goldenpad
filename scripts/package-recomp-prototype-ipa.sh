...
release_name=${GOLDENPAD_RELEASE_NAME:-0.1.0-preview.1}
...
cp "$repo_root/ref/goldeneye64recomp/COPYING" "$staged_app/COPYING-GPL-3.0.txt"
cp "$repo_root/ref/rt64/LICENSE" "$staged_app/LICENSE-RT64.txt"
cp "$repo_root/ref/rt64/src/contrib/plume/LICENSE" "$staged_app/LICENSE-Plume.txt"
cp "$repo_root/ref/rt64/src/contrib/re-spirv/LICENSE" "$staged_app/LICENSE-re-spirv.txt"
cp "$repo_root/ref/rt64/src/contrib/zstd/LICENSE" "$staged_app/LICENSE-Zstandard.txt"
cp "$repo_root/ref/goldeneye64recomp/lib/N64ModernRuntime/N64Recomp/LICENSE" "$staged_app/LICENSE-N64Recomp.txt"
cp "$repo_root/ref/goldeneye64recomp/lib/N64ModernRuntime/N64Recomp/lib/fmt/LICENSE" "$staged_app/LICENSE-fmt.txt"
cp "$repo_root/ref/goldeneye64recomp/lib/N64ModernRuntime/N64Recomp/lib/rabbitizer/LICENSE" "$staged_app/LICENSE-Rabbitizer.txt"
