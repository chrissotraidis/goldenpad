...
do
    ...
    nm -gU "$binary" | grep -q '_goldenpad_mgb64_dam_nav_state'
    nm -gU "$binary" | grep -q '_goldenpad_mgb64_set_dam_nav_bungee_mode'
    ...
    nm -gU "$binary" | grep -q '_goldenpad_mgb64_facility_door155_state'
